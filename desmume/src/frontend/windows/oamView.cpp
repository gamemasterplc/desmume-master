...
LRESULT OamView_OnPaint(HWND hwnd, oamview_struct *win, WPARAM wParam, LPARAM lParam)
{
        ...
        for(i = 0; i < 192; ++i)
        {
             win->gpu->SpriteRenderDebug(i, (u16*)(bitmap + i*320));
        }
        ...
        SetDIBitsToDevice(hdc, 180, 4, 320, 192, 0, 0, 0, 192, bitmap, (BITMAPINFO*)&bmi, DIB_RGB_COLORS);
		...
		StretchBlt(hdc, (500-SIZE_THUMB/2)-(w2/2), (200+SIZE_THUMB/2)-(h2/2), w2, h2, hdc, rc.left, rc.top, width, height, SRCCOPY);
            ...
            case WM_INITDIALOG :
                 {
					  ...
					  SetRect(&rcThumb, 500-SIZE_THUMB, 200, 500, 200+SIZE_THUMB);
